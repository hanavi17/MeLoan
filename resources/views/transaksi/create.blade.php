                      ...
                      <h4 class="card-title">Tambah Transaksi baru</h4>
                        ...
                        <div class="form-group{{ $errors->has('kode_transaksi') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('tgl_kembali') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input id="tgl_kembali" type="date"  class="form-control" name="tgl_kembali" value="{{ date('Y-m-d', strtotime(Carbon\Carbon::today()->addDays(14)->toDateString())) }}" required="" > {{--@if(Auth::user()->level == 'user') readonly @endif--}}
